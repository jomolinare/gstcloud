...
public class Tower extends Geohashed implements LocationCapable,IsSerializable
{
  ...
  @Persistent
    ...
    public Tower(String category,Double latitude, Double longitude, String placeName,List<String> geoCells) {
