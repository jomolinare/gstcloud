...
public class LocalBody implements IsSerializable
{
	@PrimaryKey
    ...
    public LocalBody(String districtName, String localBodyType,String localBodyName,Double latitude, Double longitude) 
    {
