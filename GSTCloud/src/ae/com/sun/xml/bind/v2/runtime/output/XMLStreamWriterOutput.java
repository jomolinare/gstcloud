...
public class XMLStreamWriterOutput extends XmlOutputAbstractImpl {
    ...
    private static Constructor<? extends XmlOutput> initFastInfosetOutputClass() {
        try {
            ...
            Class c = Class.forName(
                    "ae.com.sun.xml.bind.v2.runtime.output.FastInfosetStreamWriterOutput", true,
    ...
    private static Constructor<? extends XmlOutput> initStAXExOutputClass() {
        try {
            Class c = Class.forName("ae.com.sun.xml.bind.v2.runtime.output.StAXExStreamWriterOutput",true, UnmarshallerImpl.class.getClassLoader());
